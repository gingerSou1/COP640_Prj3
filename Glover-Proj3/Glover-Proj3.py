...
def page_4():
    ...
    return render_template('environmental.html', datetime=DATE_TIME, data=data, headers=headers)

@app.route('/environmental_admin.html')
def page_5():
    ...
    return render_template('environmental_admin.html', datetime=DATE_TIME, data=data, headers=headers)
